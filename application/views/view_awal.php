...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <?php if (isset($title)): ?>
            <title><?php echo $title; ?> - AppRetail</title>
        <?php else: ?>
            <title>AppRetail</title>
        <?php endif ?>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile"> <?php echo $this->session->userdata('nama_user'); ?> </span>
                                    <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                                    <img alt="" class="img-circle" src="<?php echo base_url() ?>assets/layouts/layout4/img/avatar9.jpg" /> </a>
                                <ul class="dropdown-menu dropdown-menu-default">
                                    
                                    <li>
                                       <?php echo anchor('logout', '<i class="icon-key"></i> Log Out'); ?>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <?php $this->load->view('load/menu', FALSE); ?>
                    <!-- END SIDEBAR MENU -->
                </div>
                <!-- END SIDEBAR -->
            </div>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        <!-- BEGIN PAGE TITLE -->
                        <?php if (isset($title) and isset($desk)): ?>
                        <div class="page-title">
                            <h1><?php echo $title ?>
                                <small><?php echo $desk ?></small>
                            </h1>
                        </div>
                        <?php endif ?>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                        <div class="page-toolbar" id="showtoast">
                            <!-- BEGIN THEME PANEL -->
                    ...
                    <?php 
                        if (isset($page) == TRUE) {
                            if ( ! file_exists(APPPATH.'/views/page/'.$page.'.php'))
                                {
                                    $this->load->view('page/error', FALSE);
                                }else{
                                ?>
                                ...
                                <?php
                                    $this->load->view('page/'.$page, FALSE);
                                }
                        }else{
                             $this->load->view('page/error', FALSE);
                        }
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> <?php echo date('Y'); ?> &copy; Arina.
            </div>
