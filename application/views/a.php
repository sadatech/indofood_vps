          ...
          <table cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td class="hide-for-mobile" style="padding:30px 0 10px 0;">
                <img width="100" height="100" src="<?php echo base_url('assets/layouts/layout4/img/logo_indofood_new.png'); ?>" alt="logo" />
              </td>
            </tr>
            ...
            <tr>
              <td class="hide-for-mobile"  height="150" valign="top" >
                ...
                <br>
                <span>Sudirman Plaza Indofood Tower, Lantai 27, Jl. Jend. Sudirman Kav. 76-78, Daerah Khusus Ibukota Jakarta</span>
              </td>
            </tr>
            ...
            <tr>
              <td class="body-cell body-cell-left-pad" width="355" height="661" valign="top">
                <table cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td>
                      Kepada Bpk/Ibu blabla<br>
                      <br>
                        berikut ini kami laporkan data out of stock di cabang ..... berdasarkan hasil input brand ambassador(BA) di toko
                      <br>
                      <br>
                ...
                <table cellspacing="0" cellpadding="10" width="100%">
                  ...
                  <tr>
                    <td width="">
                      <table class="data-table" cellpadding="0" border="1" cellspacing="0">
                        <tr>
                          <th colspan="3">
                            List Barang Yang Di input
                          </th>
                        </tr>
                            <tr>
                              <td>nama BA</td>
