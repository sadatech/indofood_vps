        ...
        success: function(msg){
            if(parseInt(msg)!=0)    //if no errors
            {
                ...
                for (var i = msg.length - 1; i >= 0; i--) {
                    ...
                    data += "<td id='settarget:"+msg[i]['id_target']+"' onblur='updatetargettoko(this.html)' contenteditable='true'>"+msg[i]['target']+"</td><td><a class='btn btn-xs blue' href='"+base_url+"/toko/editTarget/"+msg[i]['id_target']+"'>Update Target</a></td></tr>";
                }
