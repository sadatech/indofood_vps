$( document ).ready(function() {
  ...
  $('#sku_kat').on('change',function(){
    ...
    $.getJSON(base_url_semmi+'/indofod/api/getSkuHeader?key=ganteng&filter='+filterKategori,function(data){
  ...
  $("#nama-cabang").select2({
    ...
    submitHandler: function(form) {
        ...
        var base_url = window.location.origin;
        var base_url_semmi = window.location.origin+'';
        var href = base_url_semmi+'/indofod/api/excelReport?key=ganteng&ba='+baFilter+'&tl='+tlFilter+'&cabang='+cabangFilter+'&kota='+kotaFilter+'&startDate='+startDate+'&endDate='+endDate+'&toko='+tokoFilter;
        ...
        $('#skuDataTable').DataTable({
          ...
          ajax : {
            'url' : '/indofod/api/filterReport?key=ganteng',
            'type' : 'POST',
            'data' : filter
          }
        });
